...
![Logo Universitas Pertahanan Republik Indonesia](PBO301_Pertemuan02_GitHub/assets/logo_unhan.png)
...
Buat `uml/vehicle.puml` dari `starter/vehicle_to_reverse.h`, lalu bandingkan dengan `uml/vehicle_solution.puml`.
